...
//
// describe('The statement-symbolic-substitution', () => {
...
//             'pe":"ReturnStatement","value":"x+y+z+c","lineNumber":11}]},{"type":"else if statement","declaration":{"lineNumber":12,"type":"else if statement","name":null,"value":null,"condition":' +
//             '"b<(z)*(2)"},"body":[{"type":"AssignmentExpression","name":"c","value":"c+x+5","lineNumber":13},{"type":"ReturnStatement","value":"x+y+z+c","lineNumber":14}]},{"type":"else if st' +
//             'atement","body":[{"type":"AssignmentExpression","name":"c","value":"c+z+5","lineNumber":16},{"type":"ReturnStatement","value":"x+y+z+c","lineNumber":17}]}]},{"type":"AssignmentExp' +
//             'ression","name":"d","value":"333","lineNumber":18}]'
//         );
//     });
//
...
//             '":"c+5","lineNumber":6},{"type":"ReturnStatement","value":"x+y+z+c","lineNumber":7}]},{"type":"else if statement","declaration":{"lineNumber":8,"type":"else if statement","name":nul' +
//             'l,"value":null,"condition":"b<(z)*(2)"},"body":[{"type":"AssignmentExpression","name":"c","value":"c+x+5","lineNumber":9},{"type":"ReturnStatement","value":"x+y+z+c","lineNumber' +
//             '":10}]},{"type":"else if statement","body":[{"type":"AssignmentExpression","name":"c","value":"c+z+5","lineNumber":12},{"type":"ReturnStatement","value":"x+y+z+c","lineNumber":13}' +
//             ']}]}]'
//         );
//     });
//
